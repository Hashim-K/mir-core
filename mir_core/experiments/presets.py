# mir_core/experiments/presets.py
"""Canonical experiment preset registry.

Each preset is stored as a JSON file in the presets/ subfolder.
The filename stem IS the experiment hash — no separate index needed.
